...
class Event(models.Model):
    ...
    def _get_website_menu_entries(self):
        ...
        self.ensure_one()
        return [
            (_('Introduction'), False, 'website_event.template_intro', 1, 'introduction', False),
            ...
            (_('Info'), '/event/%s/register' % slug(self), False, 100, 'register', False),
            (_('Room'), '/event/%s/community' % slug(self), False, 80, 'community', 'community'),
        ]
