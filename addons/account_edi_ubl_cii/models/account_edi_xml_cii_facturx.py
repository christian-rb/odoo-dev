...
class AccountEdiXmlCII(models.AbstractModel):
    ...
    def _import_fill_invoice(self, invoice, tree, qty_factor):
        ...
        self._import_partner(invoice, logs, **self._import_retrieve_partner_vals(tree, role))
        self._import_currency(invoice, tree.find('.//{*}InvoiceCurrencyCode'), logs)
        ...
        self._import_document_allowance_charges(tree, invoice, qty_factor, logs)
        self._import_prepaid_amount(invoice, tree, './/{*}ApplicableHeaderTradeSettlement/{*}SpecifiedTradeSettlementHeaderMonetarySummation/{*}TotalPrepaidAmount', qty_factor, logs)
        self._import_invoice_lines(invoice, tree, './{*}SupplyChainTradeTransaction/{*}IncludedSupplyChainTradeLineItem', qty_factor, logs)
        return logs
