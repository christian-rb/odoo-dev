...
class Department(models.Model):
    ...
    has_read_access = fields.Boolean(search="_search_has_read_access", store=False)
    total_employee = fields.Integer(compute='_compute_total_employee', string='Total Employee', export_string_translation=False)
