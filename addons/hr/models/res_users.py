...
class User(models.Model):
    ...
    name_work_location_display = fields.Char(related="employee_id.name_work_location_display")
    type_work_location = fields.Selection(related="employee_id.type_work_location")
