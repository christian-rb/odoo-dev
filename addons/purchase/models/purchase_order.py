...
class PurchaseOrder(models.Model):
    ...
    def _amount_all(self):
        ...
        for order in self:
            ...
            order.amount_untaxed = total_per_tax_summary['untaxed_amount']
            order.amount_tax = total_per_tax_summary['tax_amount']
            order.amount_total = total_per_tax_summary['total_amount']
