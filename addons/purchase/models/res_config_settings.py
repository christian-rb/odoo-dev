...
class ResConfigSettings(models.TransientModel):
    ...
    group_down_payment = fields.Boolean("Down Payments", implied_group="purchase.group_down_payment", help="Allow making vendor bills for down payments on a purchase order")
