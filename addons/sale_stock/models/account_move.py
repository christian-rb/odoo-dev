...
class AccountMove(models.Model):
    ...
    def _get_invoiced_lot_values(self):
        ...
        all_invoices_amls = current_invoice_amls.sale_line_ids.move_line_ids.filtered(lambda aml: aml.move_id.state == 'posted').sorted(lambda aml: (aml.date, aml.move_name, aml.id))
...
class AccountMoveLine(models.Model):
    ...
    def _stock_account_get_anglo_saxon_price_unit(self):
        ...
        if so_line:
            ...
            account_moves = so_line.move_line_ids.move_id.filtered(lambda m: m.state == 'posted' and bool(m.reversed_entry_id) == is_line_reversing)
