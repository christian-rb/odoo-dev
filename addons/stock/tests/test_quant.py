...
class StockQuant(TransactionCase):
    ...
    def test_quant_gs1_barcode(self):
        ...
        # First, checks each individual barcodes.
        ...
        composite_barcodes = quants.sorted(lambda q: q.product_id.id).get_aggregated_barcodes()
    ...
    def test_quant_composite_barcode(self):
        ...
        # Checks each individual barcodes.
