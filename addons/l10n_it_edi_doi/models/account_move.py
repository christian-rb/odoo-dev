...
class AccountMove(models.Model):
    ...
    def _compute_l10n_it_edi_doi_intent_warning(self):
        for move in self:
            move.l10n_it_edi_doi_intent_warning = ''
            ...
            if declaration.state == 'revoked':
                move.l10n_it_edi_doi_intent_warning = declaration._build_revoked_warning_message()
                continue
            ...
            move.l10n_it_edi_doi_intent_warning = declaration._build_threshold_warning_message(declaration_invoiced, declaration_not_yet_invoiced)
    ...
    def copy_data(self, default=None):
        ...
        for move, data in zip(self, data_list):
            ...
            if not declaration._is_valid(move.company_id, move.partner_id, date, move.currency_id):
    ...
    def _post(self, soft=True):
        for company_id, records in self.grouped('company_id').items():
            ...
            if not declaration_of_intent_tax:
                continue
            declaration_tax_lines = records.invoice_line_ids.filtered(
