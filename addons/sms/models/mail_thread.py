...
from odoo.addons.sms.tools.sms_tools import render_sms_notification
...
class MailThread(models.AbstractModel):
    ...
    def _message_sms(self, body, subtype_id=False, partner_ids=False, number_field=False,
        ...
        return self.message_post(
            body=render_sms_notification(body), partner_ids=partner_ids or [],  # TDE FIXME: temp fix otherwise crash mail_thread.py
    ...
    def _notify_record_by_sms(self, message, recipients_data, msg_vals=False, sms_content=None,
        ...
        :param sms_content: Plain text to use as sms content instead of using
          message body.
