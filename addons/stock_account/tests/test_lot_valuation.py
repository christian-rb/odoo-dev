...
class TestLotValuation(TestStockValuationCommon):
    ...
    def test_disable_lot_valuation(self):
        ...
        layers_before_changes = self.product1.stock_valuation_layer_ids
        ...
        self.assertEqual(self.product1.stock_valuation_layer_ids, layers_before_changes)
    ...
    def test_change_standard_price(self):
        """ Changing standard price will reevaluate all lots """
        self._make_in_move(self.product1, 10, 5, lot_ids=[self.lot1, self.lot2])
