...
class DriverController(http.Controller):
    ...
    @http.route('/hw_drivers/download_iot_info', type='http', auth='none', csrf=False)
    def download_iot_info(self):
        ...
        ).get_response(mimetype='application/json', as_attachment=True)
