...
class DeliveryCarrier(models.Model):
    ...
    tracking_url = fields.Char(string='Tracking Link', help="This option adds a link for the customer in the portal to track their package easily. Use <shippingNumber> as a placeholder in your URL.")
