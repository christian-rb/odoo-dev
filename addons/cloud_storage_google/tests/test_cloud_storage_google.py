...
'''
        ...
        self.env['ir.config_parameter'].set_param('cloud_storage_google_account_info', self.DUMMY_GOOGLE_ACCOUNT_INFO)
    ...
    def test_uninstall_success(self):
        ...
        self.assertFalse(self.env['ir.config_parameter'].get_param('cloud_storage_google_bucket_name'))
        self.assertFalse(self.env['ir.config_parameter'].get_param('cloud_storage_google_account_info'))
