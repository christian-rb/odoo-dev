...
def list_blob_urls(bucket_name, batch_size=1000):
    global CLOUD_STORAGE_BLOBS_NUM
...
def delete_blobs(blob_urls, max_workers=None):
    ...
    def delete_blob_(blob_url):
        global DELETED_CLOUD_STORAGE_BLOBS_NUM
...
if __name__ == "__main__":
    ...
    _logger.info(
        'The cloud storage container has %d blobs. %d of them are deleted by the script',
        CLOUD_STORAGE_BLOBS_NUM, DELETED_CLOUD_STORAGE_BLOBS_NUM
    )
