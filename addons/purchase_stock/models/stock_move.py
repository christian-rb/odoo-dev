...
class StockMove(models.Model):
    ...
    def _get_price_unit(self):
        ...
        if line.product_id.purchase_method == 'purchase' and float_compare(line.qty_invoiced, received_qty, precision_rounding=line.product_uom.rounding) > 0:
            ...
            invoiced_layer = line.sudo().move_line_ids.stock_valuation_layer_ids
            ...
            invoiced_value = 0
            invoiced_qty = 0
            for invoice_line in line.sudo().move_line_ids:
    ...
    def _get_all_related_aml(self):
        ...
        return super()._get_all_related_aml() | self.purchase_line_id.move_line_ids.move_id.line_ids.filtered(
