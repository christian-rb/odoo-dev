...
<<<<<<< HEAD:addons/account_payment/models/account_journal.py
...
||||||| parent of bb65934e42fb (temp):addons/payment/models/account_journal.py
    @api.depends('outbound_payment_method_line_ids', 'inbound_payment_method_line_ids')
    def _compute_available_payment_method_ids(self):
        super()._compute_available_payment_method_ids()
...
=======
>>>>>>> bb65934e42fb (temp):addons/payment/models/account_journal.py
