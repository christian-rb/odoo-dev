...
class AccountMoveSendSInvoice(models.TransientModel):
    ...
    def _compute_l10n_vn_edi_enable(self):
        for wizard in self:
            wizard.l10n_vn_edi_enable = any(move.l10n_vn_edi_state == 'ready_to_send' for move in wizard.move_ids)
    ...
    def _hook_invoice_document_before_pdf_report_render(self, invoice, invoice_data):
        ...
        # Ensure that we still generate the file if 'generate' is un-checked but send is.
        ...
        if need_file and invoice.l10n_vn_edi_state == 'ready_to_send' and not invoice.l10n_vn_edi_sinvoice_file:
    ...
    def _call_web_service_before_invoice_pdf_render(self, invoices_data):
        ...
        for invoice, invoice_data in invoices_data.items():
            if invoice_data.get('l10n_vn_edi_send') and invoice.l10n_vn_edi_state == 'ready_to_send':
                errors = invoice._l10n_vn_edi_check_invoice_configuration()
                json_data = None
                ...
                # If the invoice was downloaded but not sent, the json file could already be there.
                    ...
                    errors.append(_('Error when generating SInvoice file.'))
    ...
    def _call_web_service_after_invoice_pdf_render(self, invoices_data):
        ...
        for invoice, invoice_data in invoices_data.items():
            ...
            files_to_attach = [invoice._l10n_vn_edi_get_xml_data(), invoice._l10n_vn_edi_get_pdf_data()]
