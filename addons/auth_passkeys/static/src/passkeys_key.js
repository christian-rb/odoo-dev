...
export class AuthPasskeysFormController extends FormController {
    #unpatch
...
registry.category("views").add("auth_passkeys_insert_creds_form", {
    ...formView,
    Controller: AuthPasskeysFormController,
})
