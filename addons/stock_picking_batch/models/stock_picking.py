...
class StockPickingType(models.Model):
    ...
    batch_grouping = fields.Boolean('Batch Grouping', compute='_compute_batch_grouping')
    wave_group_by_product = fields.Boolean('Product', help="Split transfers by product then group transfers having same product.")
    wave_group_by_category = fields.Boolean('Product Category', help="Split transfers by product category, then group transfers having same product category.")
    ...
    wave_group_by_location = fields.Boolean('Location', help="Split transfers by defined locations, then group transfers having same location.")
    ...
    wave_grouping = fields.Boolean('Wave Grouping', compute='_compute_wave_grouping')
...
class StockPicking(models.Model):
    ...
    def _find_auto_batch(self):
        ...
        if not self.picking_type_id.auto_batch or not self.picking_type_id.batch_grouping or self.batch_id or not self.move_ids or not self._is_auto_batchable():
            return False
