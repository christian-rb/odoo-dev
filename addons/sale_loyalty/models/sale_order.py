            ...
            for rule in program.rule_ids:
                ...
                if program.applies_on == 'future' and rule.reward_point_split and rule.reward_point_mode != 'order':
                    ...
                    if rule.reward_point_mode == 'order':
                        ...
                        # NOTE: this accounts for discounts -> 1 point per $ * (100$ - 30%) will result in 70 points
                        amount_paid = sum(line.price_total for line in lines_per_rule[rule] if line.product_id in so_products_per_rule.get(rule, []))
