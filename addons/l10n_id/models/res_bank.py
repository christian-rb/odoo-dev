...
class ResBank(models.Model):
    ...
    def _get_qr_vals(self, qr_method, amount, currency, debtor_partner, free_communication, structured_communication):
        ...
        if qr_method == "id_qr":
            ...
            response = self._l10n_id_make_qris_request('show_qris.php', params)
    ...
    def _l10n_id_qris_fetch_status(self, qr_data):
        ...
        """
        return self._l10n_id_make_qris_request('checkpaid_qris.php', {
            'do': 'checkStatus',
            'apikey': self.l10n_id_qris_api_key,
            'mID': self.l10n_id_qris_mid,
    ...
    @api.model
    def _l10n_id_make_qris_request(self, endpoint, params):
