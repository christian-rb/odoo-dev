...
class TestQris(AccountTestInvoicingCommon):
    ...
    def test_qris_qr_code_generation(self):
        ...
        with patch(
            'odoo.addons.l10n_id.models.res_bank.ResBank._l10n_id_make_qris_request', return_value=self.success_qris_get
        ) as patched:
        ...
        with patch(
            'odoo.addons.l10n_id.models.res_bank.ResBank._l10n_id_make_qris_request', return_value=self.success_qris_get_second
        ):
            qr_details = self.qris_qr_invoice.l10n_id_qris_invoice_details
    ...
    def test_fetch_payment_status_fail(self):
        ...
        with patch(
            'odoo.addons.l10n_id.models.res_bank.ResBank._l10n_id_make_qris_request', return_value=self.qris_status_fail
        ):
    ...
    def test_fetch_payment_status_success(self):
        ...
        with patch(
            'odoo.addons.l10n_id.models.res_bank.ResBank._l10n_id_make_qris_request', return_value=self.qris_status_success
        ):
            self.qris_qr_invoice.action_l10n_id_update_payment_status()
