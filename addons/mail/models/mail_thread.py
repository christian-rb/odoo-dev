    ...
    def _generate_tracking_message(self, message, return_line='\n'):
        ...
        for tracking in message.sudo().tracking_value_ids._filter_free_field_access():
            if tracking.field_id.ttype == 'boolean':
                ...
                old_value = tracking.old_value_char if tracking.old_value_char else str(tracking.old_value_integer)
                new_value = tracking.new_value_char if tracking.new_value_char else str(tracking.new_value_integer)
