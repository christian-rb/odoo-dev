...
class Message(models.Model):
    ...
    * snailmail.letter (snailmail addon)
    ...
    def _message_format_basic(self, format_reply=True):
        """
        This function is intended to be used when broadcasting a message to multiple users.
        The goal is to broadcast as little information as possible.
        """
        self.ensure_one()
        self.check_access_rule("read")
        record_sudo = False
        ...
        return {
            ...
            **self._message_format_extras(format_reply)
        }
    ...
    def _message_format(self, format_reply=True, msg_vals=None):
        ...
        for message in self._read_format([
            ...
            message_formated.append({
                **message_sudo._message_format_basic(format_reply),
