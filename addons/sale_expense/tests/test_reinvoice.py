...
class TestReInvoice(TestExpenseCommon, TestSaleCommon):
    ...
    def test_expenses_reinvoice(self):
        ...
        self.assertRecordValues(sale_order.order_line, [
            {'qty_delivered': 1.0, 'product_uom_qty': 1.0, 'is_expense': True, 'qty_delivered_method': 'analytic', 'name': 'expense_employee: expense_1 invoicing=order, expense=sales_price'},
            {'qty_delivered': 2.0, 'product_uom_qty': 2.0, 'is_expense': True, 'qty_delivered_method': 'analytic', 'name': 'expense_employee: expense_2 invoicing=order, expense=sales_price'},
            {'qty_delivered': 3.0, 'product_uom_qty': 3.0, 'is_expense': True, 'qty_delivered_method': 'analytic', 'name': 'expense_employee: expense_3 invoicing=delivery, expense=sales_price'},
            {'qty_delivered': 4.0, 'product_uom_qty': 4.0, 'is_expense': True, 'qty_delivered_method': 'analytic', 'name': 'expense_employee: expense_4 invoicing=delivery, expense=sales_price'},
            {'qty_delivered': 3.0, 'product_uom_qty': 3.0, 'is_expense': True, 'qty_delivered_method': 'analytic', 'name': 'expense_employee: expense_3 invoicing=delivery, expense=sales_price copy'},
            {'qty_delivered': 4.0, 'product_uom_qty': 4.0, 'is_expense': True, 'qty_delivered_method': 'analytic', 'name': 'expense_employee: expense_4 invoicing=delivery, expense=sales_price copy'},
        ])
        ...
        expense_sheet.action_approve_expense_sheets()
        expense_sheet.action_sheet_move_create()  # Lines (0-4) are still at 0 but new lines are created (stable limitation)
        ...
        expense_sheet.account_move_id.button_draft() # Lines (6-10) quantities are set to 0
        self.assertRecordValues(sale_order.order_line, [
            {'qty_delivered': 0.0, 'product_uom_qty': 0.0, 'name': 'expense_employee: expense_1 invoicing=order, expense=sales_price'},
            {'qty_delivered': 0.0, 'product_uom_qty': 0.0, 'name': 'expense_employee: expense_2 invoicing=order, expense=sales_price'},
            {'qty_delivered': 0.0, 'product_uom_qty': 0.0, 'name': 'expense_employee: expense_3 invoicing=delivery, expense=sales_price'},
        ...
        expense_sheet.account_move_id.action_post()  # Lines (6-10) are still at 0 but new lines are created (stable limitation)
        self.assertRecordValues(sale_order.order_line, [
            {'qty_delivered': 0.0, 'product_uom_qty': 0.0, 'name': 'expense_employee: expense_1 invoicing=order, expense=sales_price'},
            {'qty_delivered': 0.0, 'product_uom_qty': 0.0, 'name': 'expense_employee: expense_2 invoicing=order, expense=sales_price'},
            {'qty_delivered': 0.0, 'product_uom_qty': 0.0, 'name': 'expense_employee: expense_3 invoicing=delivery, expense=sales_price'},
        ...
        expense_sheet.account_move_id._reverse_moves() # Lines (6-10) quantities are set to 0

        self.assertRecordValues(sale_order.order_line, [
            {'qty_delivered': 0.0, 'product_uom_qty': 0.0, 'is_expense': True, 'qty_delivered_method': 'analytic', 'name': 'expense_employee: expense_1 invoicing=order, expense=sales_price'},
            {'qty_delivered': 0.0, 'product_uom_qty': 0.0, 'is_expense': True, 'qty_delivered_method': 'analytic', 'name': 'expense_employee: expense_2 invoicing=order, expense=sales_price'},
            {'qty_delivered': 0.0, 'product_uom_qty': 0.0, 'is_expense': True, 'qty_delivered_method': 'analytic', 'name': 'expense_employee: expense_3 invoicing=delivery, expense=sales_price'},
            {'qty_delivered': 0.0, 'product_uom_qty': 0.0, 'is_expense': True, 'qty_delivered_method': 'analytic', 'name': 'expense_employee: expense_4 invoicing=delivery, expense=sales_price'},
            {'qty_delivered': 3.0, 'product_uom_qty': 3.0, 'is_expense': True, 'qty_delivered_method': 'analytic', 'name': 'expense_employee: expense_3 invoicing=delivery, expense=sales_price copy'},
            {'qty_delivered': 4.0, 'product_uom_qty': 4.0, 'is_expense': True, 'qty_delivered_method': 'analytic', 'name': 'expense_employee: expense_4 invoicing=delivery, expense=sales_price copy'},
            {'qty_delivered': 0.0, 'product_uom_qty': 0.0, 'is_expense': True, 'qty_delivered_method': 'analytic', 'name': 'expense_employee: expense_1 invoicing=order, expense=sales_price'},
            {'qty_delivered': 0.0, 'product_uom_qty': 0.0, 'is_expense': True, 'qty_delivered_method': 'analytic', 'name': 'expense_employee: expense_2 invoicing=order, expense=sales_price'},
