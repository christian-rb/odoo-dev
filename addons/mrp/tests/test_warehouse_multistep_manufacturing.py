...
class TestMultistepManufacturingWarehouse(TestMrpCommon):
    ...
    def test_update_component_qty(self):
        ...
        mo.action_confirm()
        self.assertEqual(mo.move_raw_ids.product_qty, 2.0)
        self.assertEqual(mo.picking_ids.move_ids.product_qty, 2.0)
        ...
        self.assertEqual(mo.move_raw_ids.product_qty, 3.0)
        self.assertEqual(mo.picking_ids.move_ids.product_qty, 3.0)
