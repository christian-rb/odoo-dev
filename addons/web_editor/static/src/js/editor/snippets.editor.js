    ...
    _initializeOptions: function () {
        ...
        while ($element.length) {
            ...
            if (parentEditor) {
                ...
                // TODO: @owl-options This should really be removed in favor of a better
                // solution. This is only here to have a similar approach for
                // both OWL options and legacy options for a quick start.
        ...
        var defs = this.templateOptions.map((val) => {
            ...
            if (val.isOwl) {
                ...
                option.isOwl = true;
                option.renderingComponent ??= class extends SnippetOptionComponent {};
                option.renderingComponent.template = option.template;
