...
class TestWebsiteHrRecruitmentForm(odoo.tests.HttpCase):
    def test_tour(self):
        ...
        self.assertEqual(html2plaintext(guru_applicant.description), 'EXTERNAL SUBMISSION - Customer not verified\n\n\n### [GURU] HR RECRUITMENT TEST DATA ###')
        ...
        self.assertEqual(html2plaintext(internship_applicant.description), 'EXTERNAL SUBMISSION - Customer not verified\n\n\n### HR [INTERN] RECRUITMENT TEST DATA ###')
