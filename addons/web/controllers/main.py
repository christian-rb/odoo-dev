...
class Home(http.Controller):
    ...
    def switch_to_admin(self):
        ...
        if request.env.user._is_system():
            ...
            _logger.info("%r The user %r (#%d) became superuser.", LogType.BECAME_SUPERUSER,
...
class Binary(http.Controller):
    ...
    def content_common(self, xmlid=None, model='ir.attachment', id=None, field='datas',
        ...
        _logger.info("%r Document %r (#%d) accessed (potentially downloaded) by user %s (#%d)", LogType.DOCUMENT_ACCESS,
                     filename, id, request.env.user.login, request.env.user.id)
