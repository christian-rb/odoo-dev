...
import { Component, onWillRender, useEffect, useExternalListener, onWillUpdateProps, onWillStart, useRef } from "@odoo/owl";
...
export class StatusBarField extends Component {
    ...
    setup() {
        ...
        if (this.field.type === "many2one") {
            ...
            onWillUpdateProps(async () => {
                await this.fetchstatusbar(this.props);
            });
        }
    ...
    async fetchstatusbar(props) {
        ...
        this.specialData = Object.assign({}, { data: await this.env.model.orm.searchRead(relation, domain, fieldNames).then((data)=>{
