...
} from "./kanban_arch_parser_legacy";
import { KanbanCompiler } from "./kanban_compiler_legacy";
...
export class KanbanRecord extends Component {
    ...
    static template = "web.KanbanRecordLegacy";
    ...
    getRecordClasses() {
        ...
        const classes = ["o_kanban_record o_legacy_kanban d-flex"];
        if (canResequence) {
