...
test("Rendering with multiple anchors and scrolls", async () => {
    ...
    expect(isVisible(queryOne("#anchor1"))).toBe(true);
    click(".link2");
    await animationFrame();
    expect(isVisible(queryOne("#anchor2"))).toBe(true);
    click(".link3");
    await animationFrame();
    expect(isVisible(queryOne("#anchor3"))).toBe(true);
});
...
test("clicking anchor when multi levels scrollables", async () => {
    ...
    click(".btn1");
    await animationFrame();
    expect(border(queryOne("#scroll1")).top).toBeLessThan(10, {
        message: "the element must be near the top border",
    });
    click(".btn2");
    await animationFrame();
    expect(border(queryOne("#scroll2")).top).toBeLessThan(10, {
        message: "the element must be near the top border",
    });
});
...
test("Simple scroll to HTML elements", async () => {
    ...
    expect(isVisible(queryOne("#o-div-1"))).toBe(true);
    expect(isVisible(queryOne("#o-div-2"))).toBe(false);
    expect(border(queryOne("#o-div-1")).top).not.toBe(0);

    scrollTo(queryOne("#o-div-2"));
    expect(isVisible(queryOne("#o-div-1"))).toBe(false);
    expect(isVisible(queryOne("#o-div-2"))).toBe(true);
    expect(border(queryOne("#o-div-2")).bottom).toBe(0);

    scrollTo(queryOne("#o-div-1"));
    expect(isVisible(queryOne("#o-div-3"))).toBe(false);
    expect(isVisible(queryOne("#o-div-4"))).toBe(false);
    expect(border(queryOne("#o-div-1")).top).toBe(0);
    ...
    expect(isVisible(queryOne("#o-div-3"))).toBe(true);
    expect(isVisible(queryOne("#o-div-4"))).toBe(false);
    expect(border(queryOne("#o-div-3")).bottom).toBe(0);
    ...
    expect(isVisible(queryOne("#o-div-4"))).toBe(true);
    expect(border(queryOne("#o-div-4")).top).toBe(0);
    expect(border(subScrollable).top).toBe(0);
});
