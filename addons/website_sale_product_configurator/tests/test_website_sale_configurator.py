...
from odoo.addons.sale_product_configurator.tests.common import TestSaleProductConfiguratorCommon
from odoo.addons.base.tests.common import HttpCaseWithUserPortal


@tagged('post_install', '-at_install')
class TestWebsiteSaleProductConfigurator(TestSaleProductConfiguratorCommon, HttpCaseWithUserPortal):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
