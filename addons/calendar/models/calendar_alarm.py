...
class Alarm(models.Model):
    ...
    notify_responsible = fields.Boolean("Notify Responsible")
    ...
    def _onchange_duration_interval(self):
        ...
        self.name = f"{display_alarm_type} - {self.duration} {display_interval}" + (" - " + _("Notify Responsible") if self.notify_responsible else "")
