...
class Meeting(models.Model):
    ...
    stop_date = fields.Date(
        ...
        compute='_compute_dates', inverse='_inverse_dates')
    display_start = fields.Char(compute='_compute_display_start', readonly=True, store=False)
    display_stop = fields.Char(compute='_compute_display_stop', readonly=True, store=False)
    duration = fields.Float('Duration', compute='_compute_duration', store=True, readonly=False)
    display_duration = fields.Float('Display Duration', compute='_compute_display_duration', readonly=True, store=False)
    # linked document
