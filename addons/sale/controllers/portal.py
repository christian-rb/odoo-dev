        ...
        **kw
        ...
        if request.env.user.share and access_token:
            ...
            if session_obj_date != today:
                ...
                subtype_id = request.env.ref('sale.mt_order_viewed')
                follower_salesman = order_sudo.message_follower_ids.filtered(
                    lambda follower: follower.partner_id.ids == order_sudo.user_id.partner_id.ids)

                if subtype_id.id in follower_salesman.subtype_ids.ids:
