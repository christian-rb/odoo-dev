...
TableTechnicalInfo = namedtuple(
    'TableTechnicalInfo',
    ['name', 'value', 'action_url', 'action_name', 'action_target'],
    defaults=[None, None, None, 'configure', None]
)
"""A named tuple to represent a table row in the technical page."""
