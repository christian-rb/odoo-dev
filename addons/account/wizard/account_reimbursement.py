...
class AccountReimbursement(models.TransientModel):
    ...
    def _compute_communication(self):
        payment_to_reimburse_id = self.payment_id
        self.communication = f'R - {payment_to_reimburse_id.ref if payment_to_reimburse_id.ref else payment_to_reimburse_id.name}'
    ...
    def default_get(self, fields):
        res = super(AccountReimbursement, self).default_get(fields)
