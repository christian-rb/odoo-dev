import { useAutoresize, resizeTextArea } from "@web/core/utils/autoresize";
 ...
 * @param {Ref} ref
 */
export function useProductAndLabelAutoresize(ref, options = {}, resizeTextAreaMethod = productAndLabelResizeTextArea) {
    useAutoresize(ref, options, resizeTextAreaMethod);
}
