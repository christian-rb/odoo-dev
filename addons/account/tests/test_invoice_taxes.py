...
class TestInvoiceTaxes(AccountTestInvoicingCommon):
    ...
    def test_tax_line_amount_currency_modification_auto_balancing(self):
        ...
        # Can be done with a breakpoint at account_move_line.py line 1416 (`line.balance = balance`) in function _sync_invoice
        ...
        #     needed_after == {{'move_id': 34, 'date_maturity': datetime.date(2017, 1, 1), 'discount_date': False, 'discount_percentage': 0.0}: {'balance': 705.02, 'amount_currency': 1410.02, 'discount_amount_currency': 0.0, 'discount_balance': 0.0, 'discount_date': False, 'discount_percentage': 0.0}}
        #   * In comparison to before we only have to update the 'amount_currency':
        #     needed_before == {{'move_id': 34, 'date_maturity': datetime.date(2017, 1, 1), 'discount_date': False, 'discount_percentage': 0.0}: {'balance': 705.02, 'amount_currency': 1410.03, 'discount_amount_currency': 0.0, 'discount_balance': 0.0, 'discount_date': False, 'discount_percentage': 0.0}}
        #   * If we look at the execution of account.move.line/write
        #     vals == {'balance': 705.02, 'amount_currency': 1410.02, 'discount_amount_currency': 0.0, 'discount_balance': 0.0, 'discount_date': False, 'discount_percentage': 0.0}
        ...
        #   * Thus we update the balance to make it "fit" the 'amount_currency' (to 705.01 since amount_currency is now 1410.02 and the rate is 2).
