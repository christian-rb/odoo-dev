...
class TestAccountPaymentRegister(AccountTestInvoicingCommon):
    ...
    def _test_lpc_for_given_vals(self, vals):
        ...
        self.payment_term_1.write({
            ...
            'late_payment_charges_type': vals['late_payment_charges_type'],
            'late_payment_charges_value': vals['late_payment_charges_value'],
            'late_payment_charges_days': vals['late_payment_charges_days'],
            'late_payment_charges_computation': vals['late_payment_charges_computation']
        })
        ...
        if 'amount' in vals.keys():  # for facilitating partial payment
    ...
    def test_quarterly_lpc(self):
        vals = {
            'late_payment_charges_type': 'quarterly',
            'late_payment_charges_computation': 'on_total',
            'late_payment_charges_value': 10.00,
            'late_payment_charges_days': 1,
    ...
    def test_half_yearly_lpc(self):
        vals = {
            'late_payment_charges_type': 'half_yearly',
            'late_payment_charges_computation': 'on_total',
            'late_payment_charges_value': 10.00,
            'late_payment_charges_days': 2,
            'active_id': self.out_invoice_5,
    ...
    def test_yearly_lpc(self):
        vals = {
            'late_payment_charges_type': 'yearly',
            'late_payment_charges_computation': 'on_total',
            'late_payment_charges_value': 10.00,
            'late_payment_charges_days': 2,
            'active_id': self.out_invoice_5,
    ...
    def test_partial_payment_in_monthly_lpc(self):
        vals = {
            ...
            'active_id': self.out_invoice_6,
            'payment_date': '2024-04-22',
            'amount': 500.00, # partial payment amount
            'expected_lpc': 8.19,
            'ref': 'INV/2024/00002'
        }
