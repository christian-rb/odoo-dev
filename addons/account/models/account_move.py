...
class AccountMove(models.Model):
        ...
        downpayment_lines = (
            self.mapped('line_ids')
                ...
                .filtered(
                    lambda line:
                    line.is_downpayment
                    and line.move_line_ids <= self.mapped('line_ids')  # See https://github.com/odoo/odoo/pull/52648
                )
        )
    ...
    def button_draft(self):
        ...
        self.line_ids.filtered('is_downpayment')._get_order_lines().filtered(lambda sol: not sol.display_type)._compute_name()
