...
class Project(models.Model):
    ...
    def get_panel_data(self, start_date, end_date):
        ...
        if self.allow_milestones:
            panel_data['milestones'] = self._get_milestones(start_date, end_date)
    ...
    def get_milestones(self, start_date, end_date):
        if self.env.user.has_group('project.group_project_user'):
            return self._get_milestones(start_date, end_date)
        return {}
    ...
    def _get_milestones(self, start_date, end_date):
        self.ensure_one()
        domain = [('project_id', '=', self.id)]
        if start_date:
