...
export class MultiMediaImageField extends ImageField {
...
export const multiMediaImageField = {
    ...imageField,
    component: MultiMediaImageField,
};

registry.category("fields").add("multi_media_image", multiMediaImageField);
