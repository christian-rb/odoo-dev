...
class TestL10nPt(AccountTestInvoicingCommon):
    ...
    def test_l10n_pt_document_no(self):
        ...
        for (move_type, date, expected) in [
            ('out_invoice', '2022-01-01', 'out_invoice INV2022/1'),
            ('out_invoice', '2022-01-02', 'out_invoice INV2022/2'),
            ('in_invoice', '2022-01-01', 'in_invoice BILL2022/1'),
            ('out_invoice', '2022-01-03', 'out_invoice INV2022/3'),
            ('out_refund', '2022-01-01', 'out_refund RINV2022/1'),
            ('in_refund', '2022-01-01', 'in_refund RBILL2022/1'),
            ('out_invoice', '2022-01-04', 'out_invoice INV2022/4'),
            ('in_refund', '2022-01-02', 'in_refund RBILL2022/2'),
        ]:
