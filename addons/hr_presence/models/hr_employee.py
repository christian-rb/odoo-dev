...
class Employee(models.AbstractModel):
    ...
    def _check_presence(self):
        ...
        # Check on IP
        if company.hr_presence_control == 'user_ip':
        ...
        if company.hr_presence_control == 'user_email':
    ...
    def _action_set_manual_presence(self, state):
        ...
        self.write({
            ...
            "hr_icon_display": 'presence_present' if state else 'presence_absent',
        })
    ...
    def action_send_sms(self):
        ...
        if not template:
            context['default_body'] = _("Hello, you're {{ 'undefined' if object.hr_presence_state_display == 'to_define' else object.hr_presence_state_display }} in the system. Can you please confirm it's normal or correct the situation. Thanks")
        else:
