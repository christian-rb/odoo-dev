...
class TestPoSSale(TestPointOfSaleHttpCommon):
    ...
    def test_untaxed_invoiced_amount(self):
        ...
        self.assertEqual(sale_order.order_line.untaxed_amount_invoiced, 10, "Untaxed invoiced amount should be 10")
        self.assertTrue(sale_order.order_line.invoice_lines, "The sale order should have a invoice line linked to it")
