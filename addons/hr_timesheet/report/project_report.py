...
class ReportProjectTaskUser(models.Model):
    ...
    effective_hours = fields.Float('Hours Spent', readonly=True, groups="hr_timesheet.group_hr_timesheet_user")
    remaining_hours = fields.Float('Remaining Hours', readonly=True, groups="hr_timesheet.group_hr_timesheet_user")
    remaining_hours_percentage = fields.Float('Remaining Hours Percentage', readonly=True, groups="hr_timesheet.group_hr_timesheet_user")
    ...
    total_hours_spent = fields.Float("Total Hours Spent", help="Time spent on this task, including its sub-tasks.", groups="hr_timesheet.group_hr_timesheet_user")
    subtask_effective_hours = fields.Float("Hours Spent on Sub-Tasks", help="Time spent on the sub-tasks (and their own sub-tasks) of this task.", groups="hr_timesheet.group_hr_timesheet_user")
