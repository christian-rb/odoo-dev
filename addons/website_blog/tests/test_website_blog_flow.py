...
class TestWebsiteBlogFlow(TestWebsiteBlogCommon):
    ...
    def test_website_blog_followers(self):
        ...
        self.test_blog_post.write({"website_published": False, "publish_at": '2050-01-01 00:00:00', "published_date": False})
        ...
        self.test_blog_post.write({"website_published": True, "publish_at": False, "published_date": False})
