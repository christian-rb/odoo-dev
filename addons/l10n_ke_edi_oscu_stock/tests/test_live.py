...
class TestKeEdiStock(TestKeEdiCommon):
    ...
    def _test_send_picking_between_branches(self):
        ...
        branch = self.env['res.company'].search([('parent_id', '=', self.company_data['company'].id), ('name', '=', 'KAKAMEGA')])
        branch.write({
            'l10n_ke_oscu_cmc_key': 'EF78BE8AF9BD46BEB6F4E16DD0B4D5F5F019D986728E46B885E1'
        })
        ...
        # Step 3: Create receipt in Kakamega
