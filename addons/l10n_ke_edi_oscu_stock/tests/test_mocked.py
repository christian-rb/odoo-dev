...
class TestKeEdiStockMocked(TestKeEdiStock):
    ...
    def test_send_picking_between_branches(self):
        with freeze_time('2024-04-15'), self.patch_session([
            ...
            ('saveItem', 'save_item_1', 'success'),
            ('insertStockIO', 'save_stock_io_transfer_out', 'success'),  # HQ branch is processed first
            ('saveStockMaster', 'save_stock_master_19', 'success'),
            ('insertStockIO', 'save_stock_io_transfer_in', 'success'),  # Kakamega is processed second
