...
class AccountMoveSend(models.TransientModel):
    ...
    l10n_ke_enable_oscu = fields.Boolean(compute="_compute_l10n_ke_enable_oscu")
    ...
    def _compute_l10n_ke_enable_oscu(self):
        for wizard in self:
            wizard.l10n_ke_enable_oscu = any(self._get_default_l10n_ke_edi_oscu_enable(move) for move in wizard.move_ids)

    def _get_default_l10n_ke_edi_oscu_enable(self, move): # TODO - carefully consider the conditions here, maybe we need more. might want to check the country code of the invoice e.g.
