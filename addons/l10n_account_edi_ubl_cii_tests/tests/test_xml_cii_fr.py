...
class TestCIIFR(TestUBLCommon):
    ...
    def test_import_fixed_taxes(self):
        ...
        self._assert_imported_invoice_from_file(
            subfolder=subfolder, filename='facturx_ecotaxes_case1.xml', move_type='out_invoice',
            invoice_vals=expected_invoice_vals,
        )
        self._assert_imported_invoice_from_file(
            subfolder=subfolder, filename='facturx_ecotaxes_case3.xml', move_type='out_invoice',
            invoice_vals=expected_invoice_vals,
        )
        expected_invoice_vals.update({
            'amount_tax': 23,
            'invoice_lines': [{
                'name': "product_a",
                'quantity': 1,
        ...
        self._assert_imported_invoice_from_file(
            subfolder=subfolder, filename='facturx_ecotaxes_case2.xml', move_type='out_invoice',
            invoice_vals=expected_invoice_vals,
        )
