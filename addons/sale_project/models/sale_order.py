...
class SaleOrder(models.Model):
    ...
    closed_task_count = fields.Integer(compute='_compute_tasks_ids', string="Completed tasks associated with this sale")
    completed_task_percentage = fields.Float(compute="_compute_completed_task_percentage", string="Completed tasks precentage associated with this sale")
    ...
    def _compute_tasks_ids(self):
        ...
        for order, state, tasks_ids, tasks_count in tasks_per_so:
            if order:
                ...
                order.closed_task_count += state in ['1_done', '1_canceled'] and tasks_count
                so_with_tasks += order
            else:
                ...
                for task in tasks_ids:
                    ...
                    task_so.closed_task_count += state in ['1_done', '1_canceled']
