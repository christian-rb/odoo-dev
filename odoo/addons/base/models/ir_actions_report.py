...
class IrActionsReport(models.Model):
    ...
    def _render_qweb_pdf(self, res_ids=None, data=None):
        ...
        if res_ids:
            ...
            _logger.info('%r The PDF report has been generated for model: %r, records %r by user %r (#%d).'
                         ' %s', LogType.PDF_EXPORT, self_sudo.model, str(res_ids), self.env.user.login,
