                ...
                if self.check_pwd(opt.pwd):
                    ...
                    if opt.file:
                        with open(opt.file, 'r') as f:
                            fields += [tuple(l.strip().split('.')) for l in f.readlines()]
                    if opt.exclude:
                        if not opt.allfields:
                    ...
                    if opt.unobfuscate:
                        ...
                        for table in tables:
                            _logger.info("Obfuscating table ", table)
